...
public enum VerticalType {
	...
	// Finance Verticals
	FINANCE("FINANCE", CategoryType.FINANCE), CREDIT_CARDS("Credit Cards", CategoryType.FINANCE),
	...
	LUXURY_TRAVEL("Luxury Travel", CategoryType.TRAVEL), ADVENTURE_TRAVEL("Adventure Travel", CategoryType.TRAVEL),
	BUDGET_TRAVEL("Budget Travel", CategoryType.TRAVEL), TRAVEL_INSURANCE("Travel Insurance", CategoryType.TRAVEL),
	...
	LUXURY_BRANDS("Luxury Brands", CategoryType.FASHION), ATHLEISURE("Athleisure", CategoryType.FASHION),
	...
	EDUCATION("EDUCATION", CategoryType.EDUCATION), ONLINE_COURSES("Online Courses", CategoryType.EDUCATION),
	...
	FURNITURE("Furniture", CategoryType.HOME_LIVING), HOME_APPLIANCES("Home Appliances", CategoryType.HOME_LIVING),
	DECOR_ITEMS("Decor Items", CategoryType.HOME_LIVING), SMART_HOME_APPS("Smart Home Apps", CategoryType.HOME_LIVING),
	...
	ESPORTS_MERCH("Esports Merchandise", CategoryType.GAMING), VR_AR_DEVICES("VR & AR Devices", CategoryType.GAMING),
	...
	TEAM_SPORTS("Team Sports", CategoryType.SPORTS_OUTDOORS), HIKING_GEAR("Hiking Gear", CategoryType.SPORTS_OUTDOORS),
	WELLNESS_RETREATS("Wellness Retreats", CategoryType.SPORTS_OUTDOORS),

	// Pets & Animal Care Verticals
	PET_FOOD("Pet Food", CategoryType.PETS), ACCESSORIES("Accessories", CategoryType.PETS),
	PET_HEALTHCARE("Pet Healthcare", CategoryType.PETS), TRAINING_SERVICES("Training Services", CategoryType.PETS),
	...
	COOKING_APPLIANCES("Cooking Appliances", CategoryType.FOOD_BEVERAGE), TELECOM("Telecom", CategoryType.TELECOM),
	INSURANCE("Insurance", CategoryType.INSURANCE), AUTOMOBILE("Automobile", CategoryType.AUTOMOBILE),
	HOME_IMPROVEMENT("Home Improvement", CategoryType.HOME_IMPROVEMENT),
	REAL_ESTATE("Real Property", CategoryType.REAL_ESTATE), HEALTH_CARE("HEALTH_CARE", CategoryType.HEALTH_CARE);
